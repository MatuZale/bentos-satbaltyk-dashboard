...
export const BUOYS = [
  { id: "gdansk", name: "Boja — Molo w Brzeźnie (Gdańsk)", lat: 54.4142, lon: 18.6255 },
  { id: "gdynia", name: "Boja — Molo w Orłowie (Gdynia)", lat: 54.4799, lon: 18.5676 },
  { id: "sopot", name: "Boja — Molo w Sopocie", lat: 54.4482, lon: 18.5772 },
];
